        ...
        {isPending ? (
          ...
          <div className="relative">
            <div ref={ref} className={cn("absolute aspect-video h-fit w-full")}>
              ...
              <Image isBlurred radius="none" alt={movie?.title} classNames={{ wrapper: "absolute-center z-[1] bg-transparent" }} className="h-full max-h-32 w-full drop-shadow-xl" src={titleImage} />
